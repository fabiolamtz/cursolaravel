                     ...
                     <td>
                         <div class="btn-group">
                             ...
                             <!--<ul class="dropdown-menu">
                                 <li><a class="dropdown-item" href="{{route('usuarios.show', $usuario->idUsuario)}}">Ver</a></li>
                                 <li><a class="dropdown-item" href="{{route('usuarios.edit', $usuario->idUsuario)}}">Editar</a></li>
                                 <li><a class="dropdown-item" href="{{route('usuarios.destroy', $usuario->idUsuario)}}">Eliminar</a>
                                </li>
                             </ul>-->
                             <ul class="dropdown-menu">
                                <li>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <a class=" btn btn-danger" type="button" href="{{route('usuarios.destroy', $usuario->idUsuario)}}">Eliminar</a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
