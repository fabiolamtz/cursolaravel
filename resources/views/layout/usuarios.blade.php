         ...
         <div class="container" aling="center">
             <nav class="navbar navbar-expand-lg navbar-ligt bg-ligt">
                 <div class="container-fluid" aling="center">
                     <a class="navbar-brand"  href="{{url('/')}}">Registro de usuarios</a>
                         ...
                         <ul class="navbar-nav">
                             <li class="nav-item dropdown">
                                 ...
                                 <ul class="dropdown-menu" aria-labelledby="moduloProductos">
                                   <li><a class="dropdown-item" href="{{route('usuarios.index')}}">Ver Usuarios Registrados</a></li>
                                   <li><a class="dropdown-item" href="{{route('usuarios.create')}}">Registrar Nuevos Usuarios</a></li>
                                 </ul>
                             </li>
                         </ul>
                         <!--<ul class="navbar-nav">
